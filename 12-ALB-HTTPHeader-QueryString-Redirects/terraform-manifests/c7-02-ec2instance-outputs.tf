...
output "app1_ec2_private_instance_ids" {
  description = "List of IDs of instances"
  value       = [for outer_k, inner_map in module.ec2_private_app1 : inner_map["id"]]
}
## ec2_private_ip
output "app1_ec2_private_ip" {
  description = "List of private IP addresses assigned to the instances"
  value       = [for outer_k, inner_map in module.ec2_private_app1 : inner_map["private_ip"]] 
}
...
output "app2_ec2_private_instance_ids" {
  description = "List of IDs of instances"
  # value       = [for outer_k, inner_map in module.ec2_private_app2 : inner_map["id"]]
  value       = [for ec2private in module.ec2_private_app2: ec2private.id ]
}
## ec2_private_ip
output "app2_ec2_private_ip" {
  description = "List of private IP addresses assigned to the instances"
  # value       = [for outer_k, inner_map in module.ec2_private_app2 : inner_map["private_ip"]]
